...
const DeNavBar: FC = () => {
  ...
  return (
    <div
      className="flex  justify-between bg-background/90 w-full items-center gap-12 px-4 sm:px-12 lg:px-24 xl:px-40 py-2  sticky top-0 z-[900] backdrop-blur-xl font-medium "
